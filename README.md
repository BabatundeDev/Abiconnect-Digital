...
Installation
bashgit clone https://github.com/your-username/abiconnect-digital.git
cd abiconnect-digital
npm install
Development
bashnpm run dev
Production Build
...
Deployment
The project is deployed on Vercel. The vercel.json file at the project root handles SPA routing so that page refreshes and direct URL visits work correctly on all routes.
json{
  "rewrites": [
...
ScrollToTop Setup
Add the ScrollToTop component inside your router in App.jsx to reset scroll position on every navigation:
...
Contact
Email: hello@abiconnect.digital
Location: Lagos, Nigeria
Website: abiconnect-digital.vercel.app
